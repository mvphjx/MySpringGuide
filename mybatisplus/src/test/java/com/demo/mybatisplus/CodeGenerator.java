...
public class CodeGenerator
{
    ...
    public static String url = "jdbc:mysql://localhost:3306/myspring?allowPublicKeyRetrieval=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false";
    ...
    public static void main(String[] args)
    {
        ...
        focList.add(new FileOutConfig(templatePath)
        {
            ...
            public String outputFile(TableInfo tableInfo)
            {
                ...
                return projectPath + "/mybatisplus/src/main/resources/mapper/" + pc.getModuleName() + "/" + tableInfo
...
//        });
        ...
        tableFills.add(new TableFill("update_user_id", FieldFill.UPDATE));
